          ...
          <div className={`backdrop-blur-md rounded-2xl px-4 py-3 shadow-xl transition-all duration-300 ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <Button 
                  size="sm" 
                  className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 text-xs font-medium"
        ...
        <div className={`flex flex-col items-center justify-center h-full space-y-8 transition-all duration-700 ease-out ${
          isMobileMenuOpen ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
            ...
            <nav className="space-y-6 text-center">
              <a 
                href="#benefits" 
                className="block text-2xl text-white font-medium hover:text-orange-400 hover:scale-105 transition-all duration-300"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Benefits
              </a>
            ...
            <Button 
              className="bg-orange-500 hover:bg-orange-600 text-white text-lg px-8 py-4 font-medium"
              onClick={() => {
