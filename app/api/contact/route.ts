    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="background-color: #1e293b; padding: 40px 30px; text-align: center;">
            <div style="margin-bottom: 20px; text-align: center;">
                <div style="color: #f0ea45; font-size: 32px; font-weight: bold; letter-spacing: 2px;">POWERFLEX</div>
            </div>
        ...
        <div style="background-color: #f8fafc; padding: 30px; border-top: 1px solid #e2e8f0;">
            <div style="text-align: center; margin-bottom: 20px;">
                <div style="color: #1e293b; font-size: 28px; font-weight: bold; letter-spacing: 1px; margin-bottom: 15px;">APEX WIRING SOLUTIONS</div>
