    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="background-color: #f8fafc; padding: 30px; border-top: 1px solid #e2e8f0;">
            <div style="text-align: center; margin-bottom: 20px;">
                <img src="https://powerflex.apexwiringsolutions.co.uk/images/apex-logo-email.png" alt="Apex Wiring Solutions" style="height: 80px; width: auto; margin-bottom: 15px; display: block; margin-left: auto; margin-right: auto;" />
