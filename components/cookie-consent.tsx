...
export function CookieConsent({ onAccept, onDecline }: CookieConsentProps) {
  ...
  return (
    <div className="fixed inset-0 z-[10001] bg-black/50 backdrop-blur-sm flex items-end lg:items-center justify-center px-4 py-4">
      <Card className="w-full max-w-[calc(100vw-32px)] sm:max-w-md lg:max-w-2xl bg-white shadow-2xl border-0">
        <div className="p-6">
